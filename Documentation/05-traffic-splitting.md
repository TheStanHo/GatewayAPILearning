...
👉 **[Next: TLS/SSL Configuration →](./06-tls-ssl.md)**

## Related Examples

- `../Examples/04-traffic-splitting/httproute-weighted.yaml` - Weighted routing
- `../Examples/04-traffic-splitting/httproute-canary.yaml` - Canary deployment
- `../Examples/04-traffic-splitting/httproute-mirror.yaml` - Traffic mirroring
- `../Examples/04-traffic-splitting/ingress-canary-equivalent.yaml` - Nginx Ingress equivalent
