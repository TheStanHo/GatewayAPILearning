...
You can combine multiple filters in a single rule:
...
👉 **[Next: Policies →](./08-policies.md)**

## Related Examples

- `../Examples/06-filters/httproute-url-rewrite.yaml` - URL rewriting
- `../Examples/06-filters/httproute-header-modify.yaml` - Header modification
- `../Examples/06-filters/httproute-redirect.yaml` - Redirects
- `../Examples/06-filters/ingress-rewrite-equivalent.yaml` - Nginx Ingress equivalent
