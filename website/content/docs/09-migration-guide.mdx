...
> **⚠️ Urgent: Ingress NGINX Retirement**  
> Kubernetes SIG Network has announced that [Ingress NGINX will be retired in March 2026](https://kubernetes.io/blog/2025/11/11/ingress-nginx-retirement/). After that date, there will be no further releases, bugfixes, or security updates. **SIG Network recommends migrating to Gateway API immediately.** This migration guide will help you make the transition.
...
👉 **[Next: Best Practices →](/docs/10-best-practices)**
